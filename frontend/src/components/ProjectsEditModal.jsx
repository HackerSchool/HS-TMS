...
function ProjectEditModal({ open, setOpen, project, refetch }) {
    ...
    return (
        ...
        >
            ...
            <form encType='multipart/form-data' ref={formRef} id='edit-project-form' onSubmit={submitForm}>
                ...
                <div className="form-row last">
                    <button type='submit' className={`btn submit-btn ${loading && "icon-btn"}`} id='edit-ptoject-btn' >
